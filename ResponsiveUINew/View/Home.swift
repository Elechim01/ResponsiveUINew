...
//        MARK: 400 -> size bar(100) + padding(30) + piecharview(250) + spacing(20)
...
//        Relativo al padding della scrollView
        .padding(.horizontal,-15)
    }
...
//            MARK: SearchBar With Menu Button
            HStack(spacing: 10){
                if !props.isAdoptable {
                    Button {
...
//    MARK:  tabs
        let tab: [String] = [
        "Home","Table","Menu","Order","History","Report","Alert","Setting"
        ]
        VStack(spacing: 10){
           Image("Logo")
                .resizable()
